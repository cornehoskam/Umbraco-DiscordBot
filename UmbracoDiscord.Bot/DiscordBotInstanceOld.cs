...
public class DiscordBotInstanceOld
{
    ...
    public DiscordBotInstanceOld(int umbracoDiscordClientId, string umbracoDiscordClientToken, IServiceProvider serviceProvider)
    {
